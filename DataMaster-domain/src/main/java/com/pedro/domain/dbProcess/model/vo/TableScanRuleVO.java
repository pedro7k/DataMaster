...
public class TableScanRuleVO {
    ...
    public TableScanRuleVO() {
    }

    public TableScanRuleVO(int rid, int cid, int tid, int ruleWeight, int type, String valueAppear, String valueRange, String appearTimes, String appearRatio, String extInfo) {
        this.rid = rid;
        this.cid = cid;
        this.tid = tid;
