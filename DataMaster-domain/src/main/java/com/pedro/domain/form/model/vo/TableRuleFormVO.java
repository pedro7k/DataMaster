...
public class TableRuleFormVO {
    ...
    public TableRuleFormVO() {
    }

    public TableRuleFormVO(int rid, int cid, int ruleWeight, int type, String valueAppear, String valueRange, String appearTimes, String appearRatio) {
        this.rid = rid;
        this.cid = cid;
